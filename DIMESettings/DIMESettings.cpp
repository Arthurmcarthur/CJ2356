...
#define DIME_SETTINGS_INSTANCE_MUTEX_NAME L"{C474BCE7-EDC5-4CF3-8FB7-570CC51F5E19}"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    if (hMutexOneInstance == NULL || bAlreadyRunning)
    {
        ...
        SwitchToThisWindow(FindWindowW(NULL, L"倉頡三五設定"), FALSE);
        return -1;
    }
...
void showIMESettings(HWND hDlg, IME_MODE imeMode)
{
    ...
    psh.phpage = hpsp;
    psh.pszCaption = L"CJ2356 User Settings";
    ...
    StringCchPrintf(dialogCaption, MAX_PATH, L"%s v%d.%d.%d.%d", dialogCaption,
        BUILD_VER_MAJOR, BUILD_VER_MINOR, 8, BUILD_DATE_1);
